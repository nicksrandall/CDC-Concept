...
angular.module('cdcApp')
  .directive('multiLineCard', function (d3, $state, hover, cdcData) {
    return {
      template: [
        ...
        d3.json(scope.metric.data, function(error, data) {
          ...
          var linesEnter = lines.enter().append('path')
            ...
            .style('stroke-dasharray', function (d) {
              return d.name.toLowerCase().indexOf('female') >= 0 ? '5,5' : '1,0';
            })
          ...
          catsEnter.append('line')
            .attr({
              x1: 0,
              x2: 40,
              y1: function (d,i) { return 30*i ; },
              y2: function (d,i) { return 30*i; }
            })
            .style('stroke-dasharray', function (d) {
              return d.name.toLowerCase().indexOf('female') >= 0 ? '5,5' : '1,0';
            })
